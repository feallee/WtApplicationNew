...
/// @brief 版本号完整字符串。如：LGL_240311_4G_MOBI_General_PTC_V1.0.1。
#define WT_VERSION_FULL WT_PRODUCT_NAME "_" WT_BUILD_YEAR_2 WT_BUILD_YEAR_1 WT_BUILD_MONTH_2 WT_BUILD_MONTH_1 WT_BUILD_DAY_2 WT_BUILD_DAY_1 "_" WT_PRODUCT_NETWORK "_" WT_PRODUCT_CUSTOMER "_" WT_PRODUCT_FUNCTION "_" WT_PRODUCT_PROTOCOL "_" WT_VERSION_TINY
/*VERSION END*/
#endif